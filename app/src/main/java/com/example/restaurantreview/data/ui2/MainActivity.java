package com.example.restaurantreview.data.ui2;
...
import com.example.restaurantreview.data.ui.ReviewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = ApiConfig.getApiService().postReview(RESTAURANT_ID, "Rionaldi Hasibuan", review);
